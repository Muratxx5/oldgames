...
# HIDAPI DLL yolunu elle yükle
dll_path = r"C:\Users\kalip33\Documents\pydoc\hidapi-win\x64\hidapi.dll"
ctypes.CDLL(dll_path)
import hid  # DLL yüklü olduğu için hidapi modülü doğru DLL ile çalışacak
...
# -----------------------------
# Sadece touchpad'den veri okuma (VID/PID filtresi)
# -----------------------------
TOUCHPAD_VID = 0x5ac
TOUCHPAD_PID = 0x24f
...
def touchpad_hid_thread():
    ...
    try:
        while True:
            data = dev.read(64)  # Cihazın rapor boyutuna göre gerekirse ayarla
            if data:
